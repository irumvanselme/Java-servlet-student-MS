            ...
            <div class="card card-body mt-5">
                ...
                <div class="card card-body mt-5 shadow">
                    <div class="row row-cols-2 mx-0 align-baseline">
                        <div class="col font-weight-bold mt-2">id</div>
                        <div class="col"> ${student.id} </div>
                        <div class="col font-weight-bold mt-2">First name</div>
                        <div class="col"> ${student.firstName} </div>
                        <div class="col font-weight-bold mt-2">Last name</div>
                        <div class="col"> ${student.lastName} </div>
                        <div class="col font-weight-bold mt-2">Email</div>
                        <div class="col"> ${student.email} </div>
                        <div class="col font-weight-bold mt-2">Gender</div>
                        <div class="col"> ${student.gender} </div>
                        <div class="col font-weight-bold mt-2">Year</div>
                        <div class="col"> ${student.year} </div>
                        <div class="col font-weight-bold mt-2">Class</div>
                        <div class="col"> ${student.className} </div>
                    </div>
