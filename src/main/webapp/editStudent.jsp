                ...
                <form action="edit-student" method="post">
                        ...
                        <div class="d-flex">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="Male" name="gender"
                                       id="defaultCheck1"
                                       <c:if test="${student.gender==\"Male\"}">checked="checked"</c:if>/>
                    ...
                    <div class="mt-2">
                        ...
                        <select id="year" class="form-control bg-light" required name="year"
                            ...
                            <option value="Year 2" <c:if test="${student.year==\"Year 2\"}">selected="selected"</c:if>>
                                Year 2
                            </option>
                            <option value="Year 3" <c:if test="${student.year==\"Year 3\"}">selected="selected"</c:if>>
                                Year 3
                            </option>
                        </select>
                    </div>
                    <div class="mt-2">
                        ...
                        <select id="class" class="form-control bg-light" required name="class">
                            ...
                            <option value="Class A"
                                    <c:if test="${student.className==\"Class A\"}">selected="selected"</c:if>>Class A
                            </option>
                            <option value="Class B"
                                    <c:if test="${student.className==\"Class B\"}">selected="selected"</c:if>>Class B
                            </option>
                            <option value="Class C"
                                    <c:if test="${student.className==\"Class C\"}">selected="selected"</c:if>>Class C
                            </option>
                        </select>
                    </div>
                    <div class="mt-5">
